...
<body>
    ...
    <nav class="blog-nav layui-header">
        <div class="blog-container">
            ...
            <!-- 不落阁 -->
            <a class="blog-logo" href="home.html">小青年</a>
            <!-- 导航菜单 -->
            <ul class="layui-nav" lay-filter="nav">
                ...
                <li class="layui-nav-item">
                    <a href="<?php echo U('Home/index/article');?>"><i class="fa fa-file-text fa-fw"></i>&nbsp;文章专栏</a>
                </li>
                <li class="layui-nav-item">
                    <a href="<?php echo U('Home/index/resource');?>"><i class="fa fa-tags fa-fw"></i>&nbsp;资源分享</a>
                </li>
                <li class="layui-nav-item">
                    <a href="<?php echo U('Home/index/timeline');?>"><i class="fa fa-hourglass-half fa-fw"></i>&nbsp;点点滴滴</a>
                </li>
                <li class="layui-nav-item">
                    <a href="<?php echo U('Home/index/adout');?>"><i class="fa fa-info fa-fw"></i>&nbsp;关于本站</a>
                </li>
            </ul>
            <!-- 手机和平板的导航开关 -->
