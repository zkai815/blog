...
<form class="layui-form" action="<?php echo U('Links/update');?>" method="post" id="ff">
    <div class="layui-form-item">
        <label class="layui-form-label">友链名称</label>
        <div class="layui-input-block">
            <input name="links_name" value="<?php echo ($res["links_name"]); ?>" lay-verify="title" autocomplete="off" placeholder="请输入友链名称" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">友链地址</label>
        <div class="layui-input-block">
            <input name="links_url" value="<?php echo ($res["links_url"]); ?>" id="login_url" lay-verify="title" autocomplete="off" placeholder="请输入友链地址" class="layui-input" type="text">
        </div>
    </div>
    <div class="layui-form-item">
        <label class="layui-form-label">友链排序</label>
        <div class="layui-input-block">
            <input name="links_sort" value="<?php echo ($res["links_sort"]); ?>"  placeholder="请输入友链序号" class="layui-input" type="text">
        </div>
    </div>
    <label class="layui-form-label"></label>
    <div class="layui-form-item">
        <input type="hidden" name="links_id" value="<?php echo ($res["links_id"]); ?>"/>
