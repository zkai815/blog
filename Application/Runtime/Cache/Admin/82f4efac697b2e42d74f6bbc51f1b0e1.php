...
<form class="layui-form" action="<?php echo U('Admin/add');?>" method="post" id="ff">
    ...
    $(function(){
        $("#ff").validate({
            ...
            messages:{
                ...
                login_pwd: "<p style='color: #ff4500'>请输入您的密码</p>",
                repwd:{
                    required:"<p style='color: #ff4500'>请输入确认密码</p>",
                    equalTo:"<p style='color: #ff4500'>你输入的两次密码不一致</p>"
                }
            }
        })
    });
