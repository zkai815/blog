...
<form class="layui-form" action="<?php echo U('Sort/add');?>" method="post" id="ff">
    <div class="layui-form-item">
        <div class="layui-input-block">
            <input name="type_name" value="" id="type_name" lay-verify="title" autocomplete="off" placeholder="请输入分类名称" class="layui-input" type="text">
        </div>
    </div>
