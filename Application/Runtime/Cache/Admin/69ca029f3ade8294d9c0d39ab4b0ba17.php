...
<form class="layui-form" action="<?php echo U('tally/add');?>" method="post" id="ff">
    <div class="layui-form-item">
        <div class="layui-input-block">
            <input name="tally_name" id="tally_name" lay-verify="title" autocomplete="off" placeholder="请输入标签名称" class="layui-input" type="text">
        </div>
    </div>
